...
export default function AdminMessagesScreen() {
  console.log('AdminMessagesScreen rendered');
  ...
  const handleReply = (messageId: string) => {
    ...
    // Here you would typically navigate to a reply screen or open a modal
  };

  const handleBroadcast = () => {
    if (broadcastMessage.trim()) {
      console.log('Broadcasting message:', broadcastMessage);
      // Here you would typically send the broadcast message to your backend
      setBroadcastMessage('');
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.broadcastSection}>
            ...
            >
              ...
              <Text style={styles.broadcastButtonText}>Send to All Tenants</Text>
            </Pressable>
          </View>
          ...
          {mockMessages.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyDescription}>
                Messages from tenants and landlords will appear here
              </Text>
            </View>
          ) : (
